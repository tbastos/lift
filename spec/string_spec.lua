describe('Module lift.string', function()
  ...
  it('has capitalize() to capitalize a string', function()
  ...
  it('has camelize() to convert to camelCase', function()
  ...
  it('has classify() to create a class name from a string', function()
  ...
  it('has decamelize() to split camelCase using underscores', function()
  ...
  it('has dasherize() to always separate words using a dash', function()
  ...
  it('has to_bool() to convert a string to boolean', function()
  ...
  it('has escape_magic() to escape magic characters in Lua patterns', function()
    assert.equal('A%+%+ %(Hello%?%)', str.escape_magic('A++ (Hello?)'))
  end)

  it('has from_glob() to convert glob patterns to Lua patterns', function()
  ...
  it('has expand() to interpolate strings containing ${vars}', function()
    local xp = str.expand
  ...
  it('has expand_list() to expand a list of strings', function()
